...
try:
        ...
        with st.spinner('Analyzing video data... ⏳'):
            ...
            options = {
                ...
                "series": [{
                    ...
                    "radius": ["40%", "70%"],
                    "data": [
                        {"value": parsed['data'][1][2], "name": parsed['data'][1][0]},
                        {"value": parsed['data'][0][2], "name": parsed['data'][0][0]},
                        {"value": parsed['data'][2][2], "name": parsed['data'][2][0]}
                    ],
                }],
            }
    ...
    st.error(f"❌ Invalid URL! Please enter a valid YouTube link.", icon="🚨")